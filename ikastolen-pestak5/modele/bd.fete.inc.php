...
if ($_SERVER["SCRIPT_FILENAME"] == __FILE__) {
    ...
    echo "getFetesByNomF('charcut') : \n";
    print_r(getFetesByNomF("charcut"));

    echo "getFetesByAdresse(voieAdrF, cpF, villeF) : \n";
    print_r(getFetesByAdresse("Ravel", "33000", "Bordeaux"));
    
    echo "getFetesAimesByMailU(mailU) : \n";
    print_r(getFetesAimesByMailU("test@bts.sio"));
}
?>
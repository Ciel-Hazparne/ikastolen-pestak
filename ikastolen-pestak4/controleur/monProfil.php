...
$menuRecherche[] = Array("url"=>"./?action=updProfil","label"=>"Modifier mon profil");
...
if (isLoggedOn()){
    ...
    $mesFetesAimees = getFetesAimeesByMailU($mailU);
    
    $mesTypeGastronomieAimees = getTypesGastronomiePrefereesByMailU($mailU);

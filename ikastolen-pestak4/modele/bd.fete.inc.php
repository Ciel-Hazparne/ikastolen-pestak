...
function getFetesAimeesByMailU($mailU) {
    $resultat = array();
...
if ($_SERVER["SCRIPT_FILENAME"] == __FILE__) {
    ...
    echo "getFetesByNomF('Araba') : \n";
    print_r(getFetesByNomF("Araba"));

    echo "getFetesByAdresse(voieAdrF, cpF, villeF) : \n";
    print_r(getFetesByAdresse("Gaztelako Atea", "01007", "Gasteiz"));
    
    echo "getFetesAimeesByMailU(mailU) : \n";
    print_r(getFetesAimeesByMailU("ikas@snir.eus"));

...
-- Généré le :  Ven 01 Novembre 2019 à 21:56
...
(3, 'elorri.ipar@gmail.com', 5, '5/5 On s\'y retrouve chaque année entre copines :)'),
...
INSERT INTO `utilisateur` (`mailU`, `mdpU`, `pseudoU`, `admin`) VALUES
('antton.eramuzpe@euskaltel.eus', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'Antton', NULL),
('elorri.ipar@gmail.com', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'Elorri', NULL),
('hack@jevaistehacker.com', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', '&lt;p&gt;Ta BDD va exploser &lt;script type=&quot;', NULL),
('ikas@snir.eus', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'ikas', 1),
('iker.andueza@euskaltel.eus', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'Iker', NULL),
('jokin.zarzabal@gmail.com', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'jokin', NULL),
('laguntzaile@snir.eus', '$2y$12$MgoStbOyd/cJhuvI8Mk.je3shcWlAVaJ1rlYZvoAik1vX0FMcKLz2', 'Lagun', NULL);
...
--
ALTER TABLE `photo`
  MODIFY `idP` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `aimer`
  ADD CONSTRAINT `aimer_ibfk_1` FOREIGN KEY (`idF`) REFERENCES `fete` (`idF`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `aimer_ibfk_2` FOREIGN KEY (`mailU`) REFERENCES `utilisateur` (`mailU`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `critiquer`
--
ALTER TABLE `critiquer`
  ADD CONSTRAINT `critiquer_ibfk_1` FOREIGN KEY (`idF`) REFERENCES `fete` (`idF`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `critiquer_ibfk_2` FOREIGN KEY (`mailU`) REFERENCES `utilisateur` (`mailU`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `photo`
--
ALTER TABLE `photo`
  ADD CONSTRAINT `photo_ibfk_1` FOREIGN KEY (`idF`) REFERENCES `fete` (`idF`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `preferer`
--
ALTER TABLE `preferer`
  ADD CONSTRAINT `preferer_ibfk_1` FOREIGN KEY (`mailU`) REFERENCES `utilisateur` (`mailU`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `preferer_ibfk_2` FOREIGN KEY (`idTG`) REFERENCES `typeGastronomie` (`idTG`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `proposer`
--
ALTER TABLE `proposer`
  ADD CONSTRAINT `proposer_ibfk_1` FOREIGN KEY (`idF`) REFERENCES `fete` (`idF`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `proposer_ibfk_2` FOREIGN KEY (`idTG`) REFERENCES `typeGastronomie` (`idTG`) ON DELETE CASCADE ON UPDATE CASCADE;

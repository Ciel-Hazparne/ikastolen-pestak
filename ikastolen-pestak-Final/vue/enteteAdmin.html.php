...
<nav>
    <ul id="menuGeneral">
        ...
        <li><a href="./?action=gererUtilisateurs"><i class="fa fa-cog"></i> Administration</a>
            <ul class="sousMenu">
                <li><a href="./?action=ajouterUtilisateur"><i class="fa fa-user-plus"></i> Ajouter un utilisateur</a></li>
                <li><a href="./?action=gererUtilisateurs"><i class="fa fa-users"></i> Gérer les utilisateurs</a></li>
            </ul>
        </li>
